...
<form action="{{ route('categories.update', [currentAccount(), $category->uuid]) }}" method="POST" id="category-form"
    enctype="multipart/form-data" data-form="ajax-form" data-datatable="#categories-table" data-modal="#ajax_model">
    @csrf
    @method('put')
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            <input type="text" value="{{$category->title}}" class="form-control" name="category_title">
        </div>
        <div class="form-group">
            <label class="form-label" for="name">Category Secondary Title</label>
            <input type="text" value="{{$category->secondary_title}}" class="form-control" name="category_secondary_title">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div id="sortable">
                ...
                <div
                    class="sortable-item py-3 bg-white border-bottom border-light d-flex justify-content-between">
                            ...
                            <div class="form-control-wrap ">
                                ...
                                <select class="js-example-basic-multiple" name="products[]">
                                    ...
                                    @foreach($products as $product)
                                        <option @if($categoryProduct == $product->id) selected @endif value="{{$product->id}}">{{$product->title}}</option>
                                    @endforeach
                                    </select>
                        ...
                        <div class="form-group">
                            <div class="form-control-wrap ">
                                <div class="form-control-select">
                                    <select class="js-example-basic-multiple" name="products[]" data-search="off">
                                        <option></option>
                                        @foreach($products as $product)
