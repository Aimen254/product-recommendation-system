<form action="{{route('import-categories', currentAccount())}}" method="POST" id="product-form" enctype="multipart/form-data"
    ...
    <div class="modal-header align-center">
        <div class="nk-file-title">
            ...
            <div class="nk-file-name">
                <div class="nk-file-name-text"><span class="title">Import Categories</span></div>
            </div>
        </div>
