...
<div class="modal-body">
    <div class="form-group">
        ...
        <div class="custom-control custom-switch">
            <input type="checkbox" class="custom-control-input existing-new" name="reg-public" id="existing-new">
            <label class="custom-control-label" for="existing-new">Existing User?</label>
        </div>
        @endif
...
<div id="new-user">
    <form class="new-user-form" action="{{ route('users.store', currentAccount()) }}" method="POST" id="user-form" enctype="multipart/form-data" data-form="ajax-form" data-datatable="#user-table" data-modal="#ajax_model">
        @csrf
        <div class="modal-body">
            <div class="form-group">
