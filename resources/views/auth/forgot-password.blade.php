                            ...
                            <div class="card-inner card-inner-lg">
                                ...
                                <form method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control form-control-lg" name="email" id="email" placeholder="Enter your email address" required autofocus>
                                    </div>
                                    <div class="form-group">
                                        <button class="btn btn-lg btn-primary btn-block send-request">Send Reset Link</button>
                                    </div>
                                </form>
