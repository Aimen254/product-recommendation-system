                        ...
                        <div class="col-lg-9">
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{$question->is_multiple == 1 ? "checked" : ''}} class="custom-control-input" value="1" name="is_multiple" id="site-off">
                            ...
                            <div id="sortable-answers" class="h-100">
                                ...
                                <div class="answer py-3 bg-white border-bottom border-light d-flex justify-content-between">
                                    ...
                                    <span class="w-100">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control mcq_answer" name="answer[{{$answer->id}}]" onfocus="charCounter()"
                                                value="{{$answer->answer}}" placeholder="Vul meerkeuze antwoord in.." maxlength="40" id="answer{{$answer->id}}"> 
                                                <span id="charNum{{$answer->id}}">{{ 40 - strlen($answer->answer) }} characters remaining</span>
                                            </div>
                                        </div>
                                    </span>
                                ...
                                <div class="answer py-3 bg-white border-bottom border-light d-flex justify-content-between">
                                    ...
                                    <span class="w-100">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control mcq_answer" name="answer[]"
                                                    value="" placeholder="Vul meerkeuze antwoord in.." maxlength="40">
                                            </div>
                                        </div>
                                    </span>
                                    <div class="user-action align-self-center d-flex ml-2">
