                ...
                <form action = "{{ route('questions.update', [currentAccount(), currentProject(), $question->uuid]) }}" class="gy-3" method="POST"
                    ...
                    <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-9">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="hidden" class="answer-type" value="Email">
                        ...
                        <div class="col-lg-9">
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{$question->choice == "optional" ? "checked" : ''}} class="custom-control-input" value="required" name="option" id="site-off">
