...
@php
    if($numberLogics->count()){
        $route = 'email_question_logic_edit';
    }
    else{
        $route = 'email_question_logic_create';
    }
@endphp
<div class="nk-block">
    <div class="card">
        <div class="card-inner-group">
            <div class="card-inner p-0">
                <form action="{{ route('email_question_logic_create', [currentAccount(), currentProject()]) }}"
                    class="" method="POST" enctype="multipart/form-data" data-form="ajax-form"
                    data-callback="fetchData" data-editForm="editFormCallbaFck">
                    @csrf
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="form-group">
                                    <div class="form-control-wrap ">
                                        ...
                                        <select class="form-select select-question" data-search="on" name="question[]"
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap ">
                                        ...
                                        <select class="form-select select-question" data-search="on" name="question[]"
                                            ...
                                            @foreach ($questions as $question)
                                                @if ($currentQuestion->id != $question->id)
                                                    <option value="{{ $question->id }}"  @if(isset($numberLogics[1]) && $question->id == $numberLogics[1]->next_question_id) selected @endif>
                                                        {{ $question->secondary_title }}
                                                    </option>
                                                @endif
                                            @endforeach
